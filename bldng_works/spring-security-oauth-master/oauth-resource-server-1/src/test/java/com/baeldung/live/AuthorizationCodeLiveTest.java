...
public class AuthorizationCodeLiveTest {
    public final static String AUTH_SERVER = "http://localhost:28081/spring-security-oauth-server";
    public final static String RESOURCE_SERVER = "http://localhost:28082/spring-security-oauth-resource";
